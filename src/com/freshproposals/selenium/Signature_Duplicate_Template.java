...
public class Signature_Duplicate_Template extends Common_Methods {
	...
	@Test(dataProvider = "User1", priority = 0)
	 ...
	 public void open_Template() throws InterruptedException{
		 ...
		 search.click();
		 search.sendKeys("Signature_Automation");
	 ...
	 public void width() throws InterruptedException {
		 wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[@class='signature-sec ng-star-inserted']"))).click();
	 ...
	 @Test(priority = 3)
	  public void assert_width_1() throws InterruptedException {
		  wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[@class='signature-sec ng-star-inserted']"))).click();
		  String actual_reflect_width = driver.findElement(By.xpath("//div[@class='ui-draggable ui-draggable-handle rectangle selected']")).getCssValue("width");
	 ...
	 public void duplicate() throws InterruptedException{
		  ...
		  action.contextClick(driver.findElement(By.xpath("//div[@class='signature-sec ng-star-inserted']"))).perform();
		  Thread.sleep(1000);
	 ...
	 public void DragDrop() throws InterruptedException{
		 Thread.sleep(3000);
		 Actions action = new Actions(driver);
		 WebElement source = driver.findElement(By.xpath("//app-edit-section[2]//app-fpsignature[2]//div[@class='signature-sec ng-star-inserted']"));
	 ...
	 @Test(priority = 6)
	  public void assert_width_2() throws InterruptedException {
		 driver.findElement(By.xpath("//app-edit-section[2]//app-fpsignature[2]//div[@class='signature-sec ng-star-inserted']")).click();
		  String actual_reflect_width = driver.findElement(By.xpath("//app-edit-section[2]//app-fpsignature[2]//div[@class='ui-draggable ui-draggable-handle rectangle selected']")).getCssValue("width");
		  String expected_reflect_width = width_value+"px";

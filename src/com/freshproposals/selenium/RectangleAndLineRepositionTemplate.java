...
public class RectangleAndLineRepositionTemplate extends Common_Methods {
	...
	String pwd;
	 ...
	 public void GetURL() throws InterruptedException {
		 Thread.sleep(5000);
		 driver.get("http://beta1.freshproposals.net/home/templates/editTemplate/1270");
			Thread.sleep(2000);
	...
	public void RectangleRepositionVerification() throws InterruptedException {
		driver.get("http://beta1.freshproposals.net/home/templates/editTemplate/1270/true");
		Thread.sleep(5000);
		WebElement Rectangle = driver.findElement(By.xpath("//div[@id='page1-fpShape121920191581873']"));

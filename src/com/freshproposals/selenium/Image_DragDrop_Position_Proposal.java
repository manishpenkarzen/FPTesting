...
public class Image_DragDrop_Position_Proposal extends Common_Methods {
  ...
  Thread.sleep(3000);
  driver.get("https://beta.freshproposals.net/home/proposals/editProposal;proposalId=1489;editor=true");
	}
  ...
  public void Get_Position() throws InterruptedException {
	 ...
	 System.out.println("Before Drag and Drop Y "+editor_y);
	  ...
	  Thread.sleep(2000);
	  driver.get("https://beta.freshproposals.net/home/viewproposal/1489/preview/proposals;InEditProposal=true");
  ...
  @Test(priority = 3)
   public void DragDrop() throws InterruptedException {
	  ...
	  WebElement des = driver.findElement(By.xpath("//div[@id='sectionPage_4606page1']"));
	  action.clickAndHold(source).moveToElement(des, 200, 70).release().build().perform();
  }

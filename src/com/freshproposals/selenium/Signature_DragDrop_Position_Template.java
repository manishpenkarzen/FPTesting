...
public class Signature_DragDrop_Position_Template extends Common_Methods {
  ...
  Thread.sleep(3000);
  driver.get("http://beta1.freshproposals.net/home/templates/editTemplate/1253");
	}
  ...
  public void Get_Position() throws InterruptedException {
	 ...
	 System.out.println("Before Drag and Drop Y "+editor_y);
	  ...
	  Thread.sleep(2000);
	  driver.get("http://beta1.freshproposals.net/home/templates/editTemplate/1253/true");

...
public class Ellipse_Duplicate_Proposal extends Common_Methods {
	...
	@Test(priority = 1)
	  public void openExistingData() throws InterruptedException {
		  ...
		  search.click();
		  search.sendKeys("Ellipse_Automation");
	 ...
	 public void DragDrop() throws InterruptedException{
		 Thread.sleep(3000);
		 Actions action = new Actions(driver);
		 WebElement source = driver.findElement(By.xpath("//app-edit-section[2]//app-fpellipse[2]//div[@class='resizers']"));
	 ...
	 @Test(priority = 6)
	  public void assert_width_2() throws InterruptedException {
		 driver.findElement(By.xpath("//app-edit-section[2]//app-fpellipse[2]//div[@class='resizers']")).click();
		  String actual_reflect_width = driver.findElement(By.xpath("//app-edit-section[2]//app-fpellipse[2]//div[@class='resizers']")).getCssValue("width");
		  String expected_reflect_width = width_value+"px";

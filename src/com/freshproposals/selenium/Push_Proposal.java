	...
	public class Push_Proposal extends Common_Methods {
		...
		String Proposal_SectionName = "Welcome Note";
		String Section_Name;
	  ...
	  public void openExistingData() throws InterruptedException {
		  Thread.sleep(10000);
		  driver.get("https://beta.freshproposals.net/home/proposals/editProposal;proposalId=20807;editor=true");
		  Thread.sleep(15000);
	  ...
	  public void Assert() throws InterruptedException {
		  Thread.sleep(2000);
		  Assert.assertEquals(Section_Name, Proposal_SectionName);

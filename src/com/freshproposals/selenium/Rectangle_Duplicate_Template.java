...
public class Rectangle_Duplicate_Template extends Common_Methods {
	...
	@Test(dataProvider = "User1", priority = 0)
	 ...
	 public void DragDrop() throws InterruptedException{
		 Thread.sleep(3000);
		 Actions action = new Actions(driver);
		 WebElement source = driver.findElement(By.xpath("//app-edit-section[2]//app-fpshape[2]//div[@class='resizers']"));
	 ...
	 @Test(priority = 6)
	  public void assert_width_2() throws InterruptedException {
		 driver.findElement(By.xpath("//app-edit-section[2]//app-fpshape[2]//div[@class='resizers']")).click();
		  String actual_reflect_width = driver.findElement(By.xpath("//app-edit-section[2]//app-fpshape[2]//div[@class='resizers']")).getCssValue("width");
		  String expected_reflect_width = width_value+"px";

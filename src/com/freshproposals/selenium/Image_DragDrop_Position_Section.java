...
public class Image_DragDrop_Position_Section extends Common_Methods {
  ...
  Thread.sleep(3000);
  driver.get("https://beta.freshproposals.net/home/sections/editSection/4707");
	}
  ...
  public void Get_Position() throws InterruptedException {
	 ...
	 System.out.println("Before Drag and Drop Y "+editor_y);
	  ...
	  Thread.sleep(2000);
	  driver.get("https://beta.freshproposals.net/home/sections/editSection/4707/true;InEditSection=true");
  ...
  @Test(priority = 3)
   public void DragDrop() throws InterruptedException {
	  ...
	  WebElement des = driver.findElement(By.xpath("//div[@id='sectionPage_4707page1']"));
	  action.clickAndHold(source).moveToElement(des, 252, 102).release().build().perform();
  }

	...
	public class Image_Properties_Proposal extends Common_Methods {
		WebDriver driver;
		WebDriverWait wait;
		String unm;
		String pwd;
...
//		
	  ...
	  public void rotate() throws InterruptedException, AWTException {
	    ...
	    public void background_color() throws InterruptedException {
	    	//System.out.println("in background_color");
	    	//wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[@class='resizers']//img"))).click();
	    	//System.out.println("");
	    	...
	    	//wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//button[@id='e-split-btn_6']"))).click();
	    	//System.out.println("in background_color clicked");

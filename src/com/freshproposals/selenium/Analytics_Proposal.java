...
public class Analytics_Proposal extends Common_Methods {
	...
	String unm;
	String pwd;
	String summary_link = "https://beta.freshproposals.net/home/proposals/summary/20762";
  ...
  public void copyLink() throws InterruptedException {
	  driver.get("https://beta.freshproposals.net/home/proposals/editProposal;proposalId=20762;editor=true");
	  //next
	  Thread.sleep(5000);
...
//		//open analytics tab
   ...
   //compare g_time
	...
	System.out.println("Total Time Last Viewed = "+total_time_lastViewed);
